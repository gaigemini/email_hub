    ...
    try:
        ...
        for account in active_accounts:
            ...
            if account.last_checked:
                time_since = datetime.now() - account.last_checked
    ...
    try:
        ...
        for email_data in emails:
            ...
            if account.webhook_url:
                await send_to_webhook(account.webhook_url, new_message, db)
    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=10.0) as client:
            ...
            if response.status_code == 200:
                ...
                message.webhook_sent_at = datetime.now()
                db.commit()
        ...
        try:
            ...
            for account in accounts:
                ...
                if account.last_checked is None:
                    ...
                    time_since_last_check = datetime.now() - account.last_checked
